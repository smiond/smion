...
if (isServerless) {
  export function initDatabase() { return Promise.resolve() }
  export function saveChatMessage(_sessionId: string, _message: string, _isUser: boolean, _language: string = 'en') { return Promise.resolve({} as any) }
  export function getChatHistory(_sessionId: string, _limit: number = 50) { return Promise.resolve([]) }
  export function saveCVData(_section: string, _language: string, _data: string) { return Promise.resolve({} as any) }
  export function getCVData(_section: string, _language: string) { return Promise.resolve(null) }
  export function getAllCVData(_language: string) { return Promise.resolve({}) }
  export function getAllChatSessions() { return Promise.resolve([]) }
  export function getChatSessionMessages(_sessionId: string) { return Promise.resolve([]) }
  export function deleteChatSession(_sessionId: string) { return Promise.resolve({} as any) }
